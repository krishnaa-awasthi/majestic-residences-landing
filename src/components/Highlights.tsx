      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <div className="flex justify-center mb-12">
            <video
              src="https://www.godrejperoperties.in/Majesty/video.mp4"
              controls
              autoPlay
              muted
              loop
        ...
        <div className="text-center mt-10">
          <Button
            ...
            className="bg-gradient-to-r from-[#d4af37] to-[#7a5a2f] text-white text-lg px-8 py-6 rounded-full shadow-lg hover:scale-105 transition-transform duration-300"
          >
            Download Brochure
          </Button>
        </div>
